    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="flex flex-col gap-8">
        ...
        <div class="flex-1 bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <form class="p-6 grid grid-cols-1 gap-4" onSubmit$={handleSubmit}>
            ...
            <textarea name="description" value={form.value.description || ''} onInput$={handleInput} placeholder="Description" class="border p-2 rounded" />
